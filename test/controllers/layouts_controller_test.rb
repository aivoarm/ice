...
class LayoutsControllerTest < ActionController::TestCase
  ...
  test "should create layout" do
    assert_difference('Layout.count') do
      post :create, layout: { description: @layout.description, length: @layout.length, ou: @layout.ou, start: @layout.start, type: @layout.type }
    end
  ...
  test "should update layout" do
    patch :update, id: @layout, layout: { description: @layout.description, length: @layout.length, ou: @layout.ou, start: @layout.start, type: @layout.type }
    assert_redirected_to layout_path(assigns(:layout))
  end
